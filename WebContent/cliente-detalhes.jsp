...
<body>
	...
	<center>
		<form id="ClienteFormCadastro" action="Cliente.html" method="post"
			onSubmit="return confirmar('Deseja mesmo excluir?')">
			<table class="FormTableCadastro">
				<tr>
					<td><label for="ClienteNome">Nome </label></td>
					<td><input id="ClienteNome" name="clienteNome"
						class="Disabled" type="text" value="${clienteSelecionado.getNome()}"
						disabled></td>
				</tr>
				<tr>
					<td><label for="ClienteSexo">Sexo</label></td>
					<td><input id="ClienteSexo" name="clienteSexo"
						class="Disabled" type="text" value="${clienteSelecionado.getSexo() }" disabled></td>
				</tr>
				<tr>
					<td><label for="ClienteNascimento">Nascimento</label></td>
					<td><input id="ClienteNascimento" name="clienteNascimento"
						class="Disabled" type="text" value="${clienteSelecionado.getNascimentoString() }" disabled></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input id="ClienteEmail" name="clienteEmail" type="email" value="${clienteSelecionado.getEmail() }"></td>
				</tr>
				<tr>
					<td><label for="ClienteTelefone">Telefone</label></td>
					<td><input id="ClienteTelefone" name="clienteTelefone" type="text" value="${clienteSelecionado.getTelefone() }"></td>
				</tr>
			</table>
			<br />
			<table align="center">
